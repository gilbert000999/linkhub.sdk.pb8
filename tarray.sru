...
public function any getObject (integer pos) throws linkhubexception;return list[pos]
end function

public subroutine setObject(integer pos, any value) throws linkhubexception; list[pos] = value
end subroutine

public function integer getlength() throws linkhubexception;return upperbound(list)
end function
